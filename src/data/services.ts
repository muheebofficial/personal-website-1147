...
export const services: Service[] = [
  ...
  },
  {
    ...
    icon: '🧩',
    category: 'Agentic AI',
    intro: "Don't give yourself a heart attack watching your competitors steal your best customers — while you're left with the ones who'll stress and frustrate your life before they ever pay you a dime.",
    problem: "It's not luck. It's not a better product. It's an Agentic AI Automation system quietly handling the boring tasks their business used to bleed time on — tasks like answering the same questions, every single day.",
    outcomes: [
      '"Can you deliver to my location?" — answered instantly, every time',
      '"How much is this? Do you have a payment plan?" — handled without a human typing a reply',
      '"When will my delivery arrive?" — tracked and communicated automatically',
    ],
